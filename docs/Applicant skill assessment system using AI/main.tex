...
\providecommand{\say}[1]{\enquote{#1}} % \say-ийг ашигласан хэсгүүдэд fallback quote команд

\makeatletter
\let\must@origincludegraphics\includegraphics
\renewcommand{\includegraphics}[2][]{%
  \IfFileExists{#2}{%
    \must@origincludegraphics[#1]{#2}%
  }{%
    \fbox{%
      \parbox[c][2.8cm][c]{0.9\linewidth}{%
        \centering\footnotesize Missing figure: \texttt{\detokenize{#2}}%
      }%
    }%
  }%
}
...
\thesistitle{Ажил горилогчийн ур чадварыг хиймэл оюунаар
үнэлэх систем} % Таны ажлын нэр, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \ttitle командыг хэрэглэнэ
...
\supervisor{Цол Э. Батцэцэг} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \supname командыг хэрэглэнэ
\reader{Магистр (M.Sc) О.Нэр} % Шүүмжлэгчийн нэр, Дурын газарт бол \readname командыг хэрэглэнэ
\advisor{Доктор (Ph.D), Дэд профессор Ж. Оргил %эсвэл Магистр (M.Sc) О.Нэр
} % Зөвлөгчийн нэр, Дурын газарт бол \advicename командыг хэрэглэнэ
\degreeind{D071405} % Мэргэжлийн индекс, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \degreeid командыг хэрэглэнэ
...
\authorshort{Ц. Анужин} % Таны товч нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \shortname командыг хэрэглэнэ 
\authorlong{Цогтбаярын Анужин} % Таны бүтэн нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \longname командыг хэрэглэнэ 
\addresses{anujinnn.ts@gmail.com} % Таны хаяг, одоогоор ашиглаагүй. Өөр газарт бол \addressname командыг хэрэглэнэ
\subject{Компьютерын ухаан} % Таны салбар, одоогоор ашиглаагүй. Дурынр газарт бол \subjectname командыг ашиглана
\keywords{Хиймэл оюун ухаан, ур чадварын үнэлгээ, ажил горилогч, ажил олгогч, хүний нөөц, машин сургалт, чатбот, автоматжуулалт, ажлын байр, анкет} % Түлхүүр үгс, одоогоор ашиглаагүй. Дурын газарт бол \keywordnames командыг хэрэглэнэ
...
\group{Компьютерын ухааны тэнхим} % Судалгааны баг/тэнхмийн нэр, нүүр хуудсанд ашигласан. Дурын газарт бол \groupname командыг хэрэглэнэ
